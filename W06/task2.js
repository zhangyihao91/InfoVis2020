function main()
{
    ...
    {
        var id = faces[i];
        var S0 = parseInt((scalars[ id[0] ] - Math.min(...scalars)) / (Math.max(...scalars) - Math.min(...scalars)) * 255.0);
        var S1 = parseInt((scalars[ id[1] ] - Math.min(...scalars)) / (Math.max(...scalars) - Math.min(...scalars)) * 255.0);
        var S2 = parseInt((scalars[ id[2] ] - Math.min(...scalars)) / (Math.max(...scalars) - Math.min(...scalars)) * 255.0);
